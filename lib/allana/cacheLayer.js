...
const REGRAS = [
  ...
  {
    gatilhos: ['estacionamento', 'estacionar', 'parking'],
    build: () => resposta('Não temos estacionamento próprio, mas há vagas na rua.', 'general'),
  },
  {
    gatilhos: ['forma de pagamento', 'aceita pix', 'aceita cartao', 'aceita dinheiro'],
    build: () => resposta('Aceitamos crédito, débito, Pix, dinheiro, Puxe (antigo Sodexo) e BIC na função crédito.', 'general'),
  },
  {
    gatilhos: ['como reservar', 'fazer reserva', 'como faco', 'como faço', 'como faz reserva'],
